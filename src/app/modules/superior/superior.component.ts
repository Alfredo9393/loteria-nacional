...
export class SuperiorComponent implements AfterViewInit  {


  displayedColumns: string[] = ['fecha', 'numero', 'primero', 'segundo', 'tercero', 'cuarto', 
  'quinto', 'sexto', 'septimo', 'octavo', 'noveno', 'decimo','undecimo','duodecimo','decimotercero','decimocuarto','decimoquinto',
  'decimosexto','decimoseptimo','decimoctavo','decimonoveno','vigesimo','liga' ];
    ...
    data(){
      ...
      this.http.get('assets/sorteo-superior.txt', { responseType: 'text' as 'json'}).subscribe(data => {
         ...
         for (const line of this.data1.split(/[\r\n]+/)){
          ...
          // console.log("dataNoSpace: " + dataNoSpace) ;
        ...
        this.dataSource = new MatTableDataSource<PeriodicElement>(this.datos);
